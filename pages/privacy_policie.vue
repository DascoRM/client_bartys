<template>
    <div class="mb-10">
        ...
        <div>
            <ATitleBase title="Politique de confidentialité"/>
        </div>
        <div>
            <div>
                <p>
                    Le site web bartys.fr est détenu par bartys, qui est un contrôleur de données de vos données personnelles.
                </p>
                <p>
                    Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par bartys.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de bartys.fr.
                </p>
                <p>
            ...
            <div>
                <div>
                    <ATitileBase title="Pourquoi traitons-nous vos données ?"/>
                </div>
                <div>
                    <p>
...
export default class PrivacyPoliciePage extends Vue {
    layout() {
        return 'default'
    }
}
